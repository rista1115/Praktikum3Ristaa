                        ...
                        <li class="nav-item">
                            ...
                            <div class="dropdown" data-bs-theme="light">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end">
                                    <li>
                                        <h6 class="dropdown-header">v5releases</h6>
                                    </li>
            ...
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <p class="fs-5">
                        ...
                        is an open source SVG icon library featuring over 1,800 glyphs, with more added every release.
                        They're designed to work in any project, whether you use Bootstrap itself or not. Use them as
                        SVGs or icon fonts--both options give you
                        vector scaling and easy customization via CSS.
                    </p>
            ...
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <p class="fs-5">Take Bootstrap to the next level with premium themes from the
                        ...
                        Themes are built on Bootstrap as their own extended frameworks, rich with new components
                        andplugins, documentation, and powerful build tools.
                    </p>
                    <a class="icon-link icon-link-hover lead fw-semibold mb-5" href="#">
...
<?php /**PATH C:\Users\maris\rista-app\resources\views/clone.blade.php ENDPATH**/ ?>